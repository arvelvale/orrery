...
const MESSAGES = {
  en: {
    ...
    "detail.copySessionId": "Copy session ID",
    "detail.readOnly": "{name} keeps its sessions in its own database, which Orrery only reads. To delete or continue this session, use {name} itself.",
    "usage.input": "in",
    ...
    "toast.sessionIdCopied": "Session ID copied",
    ...
    "del.reason.open_in_tool": "open in the running tool",
    ...
    "del.warn.agy_title_kept": "{name} keeps its own list of past conversations, which Orrery doesn't edit, so the title may still show up there. Opening it just starts a new conversation.",
  ...
  "zh-CN": {
    ...
    "detail.copySessionId": "复制会话 ID",
    "detail.readOnly": "{name} 的会话存在它自己的数据库里，Orrery 只读不改。要删除或继续这条会话，请在 {name} 里操作。",
    "usage.input": "输入",
    ...
    "toast.sessionIdCopied": "已复制会话 ID",
    ...
    "del.reason.open_in_tool": "正在该工具里打开",
    ...
    "del.warn.agy_title_kept": "{name} 自己的历史列表 Orrery 不改，所以那里可能还留着这个标题；打开它只会开一个新对话。",
  ...
  ja: {
    ...
    "detail.copySessionId": "セッション ID をコピー",
    "detail.readOnly": "{name} のセッションはツール自身のデータベースにあり、Orrery は読み取るだけです。削除や再開は {name} で行ってください。",
    "usage.input": "入力",
    ...
    "toast.sessionIdCopied": "セッション ID をコピーしました",
    ...
    "del.reason.open_in_tool": "ツールで開いています",
    ...
    "del.warn.agy_title_kept": "{name} 自身の会話履歴は Orrery が変更しないため、タイトルが残ることがあります。開くと新しい会話が始まるだけです。",
